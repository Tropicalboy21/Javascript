...
// node_modules/three-bas/dist/bas.module.js
var BaseAnimationMaterial = class extends ShaderMaterial {
...
var BasicAnimationMaterial = class extends BaseAnimationMaterial {
  /**
  ...
  concatVertexShader() {
    return ShaderLib.basic.vertexShader.replace(
      "void main() {",
      `
  ...
  concatFragmentShader() {
    return ShaderLib.basic.fragmentShader.replace(
      "void main() {",
      `
...
var LambertAnimationMaterial = class extends BaseAnimationMaterial {
  /**
  ...
  concatVertexShader() {
    return ShaderLib.lambert.vertexShader.replace(
      "void main() {",
      `
        ${this.stringifyChunk("vertexParameters")}
        ${this.stringifyChunk("varyingParameters")}
  ...
  concatFragmentShader() {
    return ShaderLib.lambert.fragmentShader.replace(
      "void main() {",
      `
        ${this.stringifyChunk("fragmentParameters")}
        ${this.stringifyChunk("varyingParameters")}
...
var PhongAnimationMaterial = class extends BaseAnimationMaterial {
  /**
  ...
  concatVertexShader() {
    return ShaderLib.phong.vertexShader.replace(
      "void main() {",
      `
        ${this.stringifyChunk("vertexParameters")}
        ${this.stringifyChunk("varyingParameters")}
  ...
  concatFragmentShader() {
    return ShaderLib.phong.fragmentShader.replace(
      "void main() {",
      `
        ${this.stringifyChunk("fragmentParameters")}
        ${this.stringifyChunk("varyingParameters")}
...
var StandardAnimationMaterial = class extends BaseAnimationMaterial {
  /**
  ...
  concatVertexShader() {
    return ShaderLib.standard.vertexShader.replace(
      "void main() {",
      `
        ${this.stringifyChunk("vertexParameters")}
        ${this.stringifyChunk("varyingParameters")}
  ...
  concatFragmentShader() {
    return ShaderLib.standard.fragmentShader.replace(
      "void main() {",
      `
        ${this.stringifyChunk("fragmentParameters")}
        ${this.stringifyChunk("varyingParameters")}
...
var ToonAnimationMaterial = class extends BaseAnimationMaterial {
  /**
  ...
  concatVertexShader() {
    return ShaderLib.toon.vertexShader.replace(
      "void main() {",
      `
        ${this.stringifyChunk("vertexParameters")}
        ${this.stringifyChunk("varyingParameters")}
  ...
  concatFragmentShader() {
    return ShaderLib.toon.fragmentShader.replace(
      "void main() {",
      `
        ${this.stringifyChunk("fragmentParameters")}
        ${this.stringifyChunk("varyingParameters")}
...
var PointsAnimationMaterial = class extends BaseAnimationMaterial {
  /**
  ...
  concatVertexShader() {
    return ShaderLib.points.vertexShader.replace(
      "void main() {",
      `
        ${this.stringifyChunk("vertexParameters")}
        ${this.stringifyChunk("varyingParameters")}
  ...
  concatFragmentShader() {
    return ShaderLib.points.fragmentShader.replace(
      "void main() {",
      `
        ${this.stringifyChunk("fragmentParameters")}
        ${this.stringifyChunk("varyingParameters")}
...
var DepthAnimationMaterial = class extends BaseAnimationMaterial {
  constructor(parameters) {
  ...
  concatVertexShader() {
    return ShaderLib.depth.vertexShader.replace(
      "void main() {",
      `
        ${this.stringifyChunk("vertexParameters")}
        ${this.stringifyChunk("vertexFunctions")}
...
var DistanceAnimationMaterial = class extends BaseAnimationMaterial {
  constructor(parameters) {
  ...
  concatVertexShader() {
    return ShaderLib.distanceRGBA.vertexShader.replace(
      "void main() {",
      `
        ${this.stringifyChunk("vertexParameters")}
        ${this.stringifyChunk("vertexFunctions")}
...
var PrefabBufferGeometry = class extends BufferGeometry {
  /**
...
var MultiPrefabBufferGeometry = class extends BufferGeometry {
  /**
  ...
  */
  setPrefabData(attribute, prefabIndex, data) {
    ...
    for (let i2 = 0; i2 < prefabGeometryVertexCount; i2++) {
      for (let j = 0; j < attribute.itemSize; j++) {
        attribute.array[offset++] = data[j];
      }
    }
...
var InstancedPrefabBufferGeometry = class extends InstancedBufferGeometry {
  /**
...
var Utils = {
  ...
  randomAxis: function(v) {
    v = v || new Vector3();
    v.x = MathUtils.randFloatSpread(2);
    v.y = MathUtils.randFloatSpread(2);
    v.z = MathUtils.randFloatSpread(2);
    v.normalize();
    return v;
  },
  /**
...
var ModelBufferGeometry = class extends BufferGeometry {
  /**
...
var PointBufferGeometry = class extends BufferGeometry {
  /**
...
//# sourceMappingURL=three-bas.js.map
